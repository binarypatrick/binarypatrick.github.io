...
![Download Version](../../../assets/images/2021/asp-net-core-server-setup/download-modal.png)
...
![Download hosting bundle](../../../assets/images/2021/asp-net-core-server-setup/download-hosting-bundle.png)

![dotnet info](../../../assets/images/2021/asp-net-core-server-setup/dotnet-info.png)

## IIS

One of the first things I do when configuring IIS is set up the HTTPS binding.

![Website bindings](../../../assets/images/2021/asp-net-core-server-setup/website-bindings.png)
...
![HTTP Response Header location](../../../assets/images/2021/asp-net-core-server-setup/header-location.png)
...
![HSTS Settings](../../../assets/images/2021/asp-net-core-server-setup/hsts-settings.png)
...
![Configuration editor](../../../assets/images/2021/asp-net-core-server-setup/configuration-editor.png)
...
![powershell agent install](../../../assets/images/2021/asp-net-core-server-setup/powershell-agent-install.png)
